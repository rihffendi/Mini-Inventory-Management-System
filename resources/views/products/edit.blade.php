		        ...
		        <div class="col-sm-12 col-md-6">
		            <div class="form-group pb-2">
		              <div class="input-group mb-2">
		                ...
		                <input type="text" class="form-control" placeholder="Product Name" aria-label="Product Name" aria-describedby="basic-addon1" name="name" value="{{$product->name}}"> </div>
		            </div>
		            	...
		            	<div class="input-group mb-3">
							...
							<select class="form-control" name="category" id="category">
							  @foreach($category as $categories)
							  	<option value="{{$categories->id}}"  {{$categories->name == $product->category_name ? 'selected' : ''}}>{{$categories->name}}
							  	</option>
							  @endforeach
			                </select>
			            </div>
							...
							<select class="form-control" name="subcategory" id="subcategory" disabled>
								@if($product->sub_category_name != '')
									@foreach($subcategory as $subcategories)
									  	<option value="{{$subcategories->id}}"  {{$subcategories->name == $product->sub_category_name ? 'selected' : ''}}>{{$subcategories->name}}
									  	</option>
								  	@endforeach
								@endif
			                </select>
		          	 ...
		          	 <div class="form-row">
						<div class="form-group col-md-6">
						 	<div class="input-group mb-3">
				                ...
				                <input type="text" class="form-control" placeholder="Product Code" aria-label="Product Code" aria-describedby="basic-addon1" name="product_code" value="{{$product->product_code}}"> 
				            </div>
						</div>
						<div class="form-group col-md-6">
							<div class="input-group mb-3">
				                ...
				                <input type="number" class="form-control" placeholder="Alert Quantity" aria-label="Alert Quantity" aria-describedby="basic-addon1" name="alert_quantity" value="{{$product->alert_quantity}}"> 
				            </div>
						</div>
					</div>
		        </div>
		        <div class="col-sm-12 col-md-6">
		            ...
		            <div class="form-row">
						<div class="form-group col-md-6">
						 	<div class="input-group mb-3">
				                ...
				                <input type="number" class="form-control" placeholder="Product Cost" aria-label="Product Cost" aria-describedby="basic-addon1" name="product_cost" value="{{$product->product_cost}}"> 
				            </div>
						</div>
						<div class="form-group col-md-6">
							<div class="input-group mb-3">
				                ...
				                <input type="number" class="form-control" placeholder="Product Price" aria-label="Product Price" aria-describedby="basic-addon1" name="product_price" value="{{$product->product_price}}"> 
				            </div>
						</div>
					</div>
					<div class="form-group">
		              <div class="input-group mb-3 mt-2">
		                ...
		                <input type="number" class="form-control" placeholder="Product Tax" aria-label="Product Tax" aria-describedby="basic-addon1" name="tax" value="{{$product->tax}}"> </div>
		            </div>
		            <div class="form-group">
		              <div class="input-group mb-3 mt-4">
		                ...
		                <textarea class="form-control" placeholder="Product Details" aria-label="Product Details" aria-describedby="basic-addon1" name="product_details">{{$product->product_details}}</textarea> </div>
		            </div>
		            <button type="submit" class="mb-2 mt-5 btn btn-primary mr-2 float-right">Update</button>
