...
<div class="mb-4">
	<div class="card card-small ">
 		<form id="supplierForm" action="{{route('people.suppliers.store')}}" method="post">
 			@csrf
		        ...
		        <div class="col-sm-12 col-md-6">
		            <div class="form-group">
		              <div class="input-group mb-3">
		                ...
		                <input type="text" class="form-control" placeholder="Supplier Name" aria-label="Supplier Name" aria-describedby="basic-addon1" name="name"> </div>
		            </div>
		            <div class="form-group">
		              <div class="input-group mb-3">
		                <div class="input-group-prepend">
		                ...
		                <input type="text" class="form-control" placeholder="Supplier Phone" aria-label="Supplier Phone" aria-describedby="basic-addon1" name="phone"> </div>
		            </div>
		            <div class="form-group">
		              <div class="input-group mb-3">
		                <div class="input-group-prepend">
		                ...
		                <input type="email" class="form-control" placeholder="Supplier Email" aria-label="Supplier Email" aria-describedby="basic-addon1" name="email"> </div>
		            </div>
		            <div class="form-group">
		              <div class="input-group mb-3">
		                <div class="input-group-prepend">
		                ...
		                <input type="text" class="form-control" placeholder="Supplier Company" aria-label="Supplier Company" aria-describedby="basic-addon1" name="company"> </div>
		            </div>
		        </div>
		        <div class="col-sm-12 col-md-6">
		        	 <div class="form-group">
		              <div class="input-group mb-3">
		                ...
		                <input type="text" class="form-control" placeholder="Supplier Address" aria-label="Supplier Address" aria-describedby="basic-addon1" name="address"> </div>
		            </div>
					<div class="form-group">
						<div class="input-group mb-3">
			                <div class="input-group-prepend">
		             ...
		             <div class="form-group">
		              <div class="input-group mb-3">
		                ...
		                <textarea class="form-control" placeholder="Supplier Details" aria-label="Supplier Details" aria-describedby="basic-addon1" name="details"></textarea></div>
		            </div>
