...
<div class="col-lg-12 mb-4">
	<div class="card card-small">
		<form id="employeeForm" action="{{route('people.employees.update', $employee->id)}}" method="post">
			@csrf
		        ...
		        <div class="col-sm-12 col-md-6">
		            <div class="form-group">
		              <div class="input-group mb-4">
		                ...
		                <input type="text" class="form-control" placeholder="Employee Name" aria-label="Employee Name" aria-describedby="basic-addon1" name="name" value="{{$employee->name}}"> </div>
		            </div>
		            <div class="form-group">
		              <div class="input-group mb-4">
		                <div class="input-group-prepend">
		                ...
		                <input type="text" class="form-control" placeholder="Employee Phone" aria-label="Employee Phone" aria-describedby="basic-addon1" name="phone" value="{{$employee->phone}}"> </div>
		            </div>
		            <div class="form-group">
		              <div class="input-group mb-3">
		                ...
		                <input type="email" class="form-control" placeholder="Employee Email" aria-label="Employee Email" aria-describedby="basic-addon1" name="email" value="{{$employee->email}}"> </div>
		            </div>
		            <div class="form-group">
		              <div class="input-group mb-3">
		                <div class="input-group-prepend">
		                ...
		                <input type="text" class="form-control" placeholder="Naional ID" aria-label="Employee NID" aria-describedby="basic-addon1" name="national_id" value="{{$employee->national_id}}"> </div>
		            </div>
		        </div>
		        <div class="col-sm-12 col-md-6">
		          	<div class="form-row">
						...
						<div class="form-group col-md-6">
							<div class="input-group mb-3">
								...
								<select name="gender" id="inputState" class="form-control"  aria-label="gender" aria-describedby="basic-addon1">
								  <option value="1" {{$employee->gender == 1 ? 'selected' : ''}}>Male</option>
								  <option value="0" {{$employee->gender == 0 ? 'selected' : ''}}>Female</option>
							    </select>
							</div>
						</div>
					</div>
		            <div class="form-group">
		              <div class="input-group mb-3">
		                ...
		                <input type="text" class="form-control" placeholder="Employee Address" aria-label="Employee Address" aria-describedby="basic-addon1" name="address" value="{{$employee->address}}"></div>
		            </div>
	             	<div class="form-group">
		              <div class="input-group mb-3">
		                <div class="input-group-prepend">
		                ...
		                <input type="text" class="form-control"placeholder="Employee Age" aria-label="Employee Age" aria-describedby="basic-addon1" name="age" value="{{$employee->age}}"></div>
		            </div>
		            <div class="form-group">
		              <div class="input-group mb-3">
		                <div class="input-group-prepend">
		                ...
		                <input type="text" class="form-control" placeholder="Employee Salary" aria-label="Employee Salary" aria-describedby="basic-addon1" name="salary" value="{{$employee->salary}}"></div>
		            </div>
