...
<div class="col-lg-12 mb-4">
	<div class="card card-small">
		<form id="categoryForm" action="{{route('category.categories.store')}}" method="post">
			@csrf
		        ...
		        <div class="col-sm-12 col-md-12">
		            <div class="form-group pb-2">
		              <div class="input-group mb-2">
		                ...
		                <input type="text" class="form-control" placeholder="Category Name" aria-label="Category Name" aria-describedby="basic-addon1"name="name"> </div>
		            </div>
